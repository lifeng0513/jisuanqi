...
window.onload = function(){
  ...
  var d1 = new Date();
  sj1.innerHTML = d1.getHours() + ':' + d1.getMinutes();
...
denghao.onclick = function(){
 ...
 // }
   ...
   var jisuanqi1 = document.getElementById('jisuanqi1');
  ...
  bb.onclick = function(){
     jisuanqi.style.display='block';
     jisuanqi1.style.display='none';
     p.style.display = 'none';
   } 
  kk.onclick = function(){
     jisuanqi.style.display='none';
     jisuanqi1.style.display='block';
     p.style.display = 'none';
   } 
